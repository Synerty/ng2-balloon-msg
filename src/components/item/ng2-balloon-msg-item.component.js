...
var rapui_usr_msg_service_1 = require("../usr-msg-service/ng2-balloon-msg.service");
var Ng2BalloonMsgItemComponent = (function () {
    function Ng2BalloonMsgItemComponent() {
        ...
        this.expireDuration = 2500; // showDuration + fade in/out time
    }
    Ng2BalloonMsgItemComponent.prototype.ngOnInit = function () {
        var _this = this;
        console.log("ngOnInit " + this.msgDetails.type);
        // Hide the message after a certain period.
        if (this.msgDetails.type !== rapui_usr_msg_service_1.UsrMsgLevel.Error) {
    ...
    __decorate([
        core_1.Input()
    ], Ng2BalloonMsgItemComponent.prototype, "msgDetails");
